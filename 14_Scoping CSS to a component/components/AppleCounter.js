...
const AppleCounter = () => {
  ...
  return (
    ...
    <div className='wrapper-2 txtXl'>
        <AppleBasket className='basket-1' applecount={leftAppleCount} basketno="1" >
prajwol</AppleBasket>
        <Button click={leftclickevent} className="left-basket-img" imageurl={LeftArrow} title="leftarrow" ></Button>
        <Button click={rightclickevent} className="Right-basket-img" imageurl={RigthArrow} title="rightarrow"></Button>
        <AppleBasket className='basket-2' applecount={rightAppleCount} basketno="2" children='prajwol' />
    </div>
